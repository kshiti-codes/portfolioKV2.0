...
export const liveTools: LiveTool[] = [
    {
        ...
        image: './images/projects/jobapplicationanalyser.gif', // You'll need to create/add this image
        category: 'AI Tools',
    ...
    },
    {
        ...
        image: './images/projects/react-playground.gif', // You'll need to create/add this image
